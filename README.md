...
- **Tasks:** **Terminal → Run Task…** (or `Cmd+Shift+B` / `Ctrl+Shift+B`), then choose **Tests: TypeScript**, **Tests: Go**, **Tests: Python**, **Tests: Java**, **Tests: C#**, or **Tests: All** to run every language’s tests.
...
- **Recommended extensions:** When opening in VS Code or Codespaces, accept the recommended extensions (TypeScript/ESLint, Go, Python, Java, C#, Vitest) for the best experience.
...
Languages: `typescript`, `go`, `python`, `java`, `csharp`.
